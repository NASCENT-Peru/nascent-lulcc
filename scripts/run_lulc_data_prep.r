#!/usr/bin/env Rscript
# run_lulc_data_prep.r
# Run LULC data preparation

# Capture start time
start_time <- Sys.time()

cat("\n========================================\n")
cat("Starting LULC Data Preparation\n")
cat("========================================\n\n")
...
# Run LULC data preparation
cat("========================================\n")
cat("Running LULC Data Preparation\n")
cat("========================================\n")
...
result <- tryCatch(
  ...
  error = function(e) {
    cat(sprintf("ERROR in LULC Data Preparation: %s\n", e$message))
...
cat("\n========================================\n")
cat("LULC Data Preparation Summary\n")
cat("========================================\n")
...
cat(sprintf(
  "\nLULC data preparation completed with exit code: %d\n",
  exit_code
))
