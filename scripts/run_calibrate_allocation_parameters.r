...
# Run calibrate allocation parameters
cat("========================================\n")
cat("Running Calibrate Allocation Parameters\n")
cat("========================================\n")
...
result <- tryCatch(
  ...
  error = function(e) {
    cat(sprintf("ERROR in Calibrate Allocation Parameters: %s\n", e$message))
...
cat("\n========================================\n")
cat("Calibrate Allocation Parameters Summary\n")
cat("========================================\n")
...
summary_file <- file.path(
  "logs",
  sprintf(
    "calibrate_allocation_parameters_summary_%s.txt",
...
cat(sprintf(
  "\nCalibrate allocation parameters completed with exit code: %d\n",
  exit_code
))
