#!/usr/bin/env Rscript
# run_predictor_parquets.r
# Run predictor parquet creation

# Capture start time
start_time <- Sys.time()

cat("\n========================================\n")
cat("Starting Predictor Parquet Creation\n")
cat("========================================\n\n")
...
# Run predictor parquet creation
cat("========================================\n")
cat("Running Predictor Parquet Creation\n")
cat("========================================\n")
...
result <- tryCatch(
  ...
  error = function(e) {
    cat(sprintf("ERROR in Predictor Parquet Creation: %s\n", e$message))
...
cat("\n========================================\n")
cat("Predictor Parquet Creation Summary\n")
cat("========================================\n")
...
summary_file <- file.path(
  "logs",
  sprintf(
    "predictor_parquets_summary_%s.txt",
...
cat(sprintf(
  "\nPredictor parquet creation completed with exit code: %d\n",
  exit_code
))
